...
<div class="flex min-h-screen w-full items-start justify-center px-4 pt-20 md:pt-32 lg:pt-20">
    <div class="w-full max-w-sm rounded bg-white px-4 py-6 shadow-md md:max-w-md">
